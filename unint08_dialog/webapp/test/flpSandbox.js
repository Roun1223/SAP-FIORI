		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#unint08dialog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"unint08dialog-display": {
								"semanticObject": "unint08dialog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=unint08dialog",
									"url": sap.ui.require.toUrl("unint08dialog")
								}
							}
						}
					}
