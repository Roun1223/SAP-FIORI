		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exercise7fragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exercise7fragment-display": {
								"semanticObject": "exercise7fragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exercise7fragment",
									"url": sap.ui.require.toUrl("exercise7fragment")
								}
							}
						}
					}
