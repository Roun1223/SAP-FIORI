		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exercise9propertybinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exercise9propertybinding-display": {
								"semanticObject": "exercise9propertybinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exercise9propertybinding",
									"url": sap.ui.require.toUrl("exercise9propertybinding")
								}
							}
						}
					}
