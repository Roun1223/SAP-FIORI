		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#unit9propertybinding2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"unit9propertybinding2-display": {
								"semanticObject": "unit9propertybinding2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=unit9propertybinding2",
									"url": sap.ui.require.toUrl("unit9propertybinding2")
								}
							}
						}
					}
